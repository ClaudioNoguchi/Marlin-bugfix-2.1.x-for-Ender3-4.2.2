...
namespace LanguageNarrow_pt_br {
  ...
  LSTR MSG_AUTO_HOME                      = _UxGT("Auto Home XYZ");                          // Auto Home
  ...
  LSTR MSG_SET_HOME_OFFSETS               = _UxGT("Ajuste: Ponto Zero");                         // Set Home Offsets
  ...
  LSTR MSG_PREHEAT_1_ALL                  = _UxGT("Pre-aq.Tudo ") PREHEAT_1_LABEL;             // Preheat (PREHEAT_1_LABEL) All
  ...
  LSTR MSG_MPC_HEATING_PAST_200           = _UxGT("Aquecendo até >200C");
  ...
  LSTR MSG_BUTTON_LEVEL                   = _UxGT("Nivelar");
  ...
  LSTR MSG_PROBE_WIZARD                   = _UxGT("Assistente Z-offset");
  LSTR MSG_PROBE_WIZARD_PROBING           = _UxGT("Referência de Z");
  LSTR MSG_PROBE_WIZARD_MOVING            = _UxGT("Movendo Posição prova");
  LSTR MSG_TRAMMING_WIZARD                = _UxGT("Ajuste de Molas");
  LSTR MSG_ZPROBE_OUT                     = _UxGT("Sonda fora da mesa");                       // Z Probe Past Bed
  LSTR MSG_MOVE_NOZZLE_TO_BED             = _UxGT("Aproxime: Bico a Mesa");
  ...
  LSTR MSG_ERR_THERMAL_RUNAWAY            = _UxGT("FALHA TÉRMICA");                           // THERMAL RUNAWAY
  ...
  LSTR MSG_BED_TRAMMING                   = _UxGT("Nivelar Molas");                           // Bed Tramming
  LSTR MSG_BED_TRAMMING_RAISE             = _UxGT("Ajuste a mola até a sonda aceitar o nivelamento.");
  LSTR MSG_BED_TRAMMING_IN_RANGE          = _UxGT("Cantos em tolerancia. Mesa nivelada.");
  LSTR MSG_BED_TRAMMING_GOOD_POINTS       = _UxGT("Pontos OK: ");
  ...
  LSTR MSG_UBL_Z_OFFSET                   = _UxGT("Ajuste Z-offset: ");                          // Z-Offset:
  LSTR MSG_UBL_Z_OFFSET_STOPPED           = _UxGT("Ajuste Z parou");                      // Z-Offset Stopped
  ...
  LSTR MSG_RELEASE_SD                     = _UxGT("Remover SD Card");
    LSTR MSG_MEDIA_MENU_SD                = _UxGT("Imprimir do SD");
  LSTR MSG_SKEW_FACTOR                    = _UxGT("Fator de Esquadro");                         // Skew Factor
  ...
  LSTR MSG_SELECT_ORIGIN                  = _UxGT("Selecione Origem");
  LSTR MSG_TRAM_FL                        = _UxGT("Frente Esq.");
  LSTR MSG_TRAM_FR                        = _UxGT("Frente Dir.");
  LSTR MSG_TRAM_C                         = _UxGT("Centro");
  LSTR MSG_TRAM_BL                        = _UxGT("Fundo Esq.");
  LSTR MSG_TRAM_BR                        = _UxGT("Fundo Dir.");
}
